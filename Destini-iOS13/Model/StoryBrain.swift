...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice: String) {
        if userChoice == storys[count].choice1 {
            count = storys[count].choice1Destination
        } else {
            count = storys[count].choice2Destination
        }
    }
    
    func getTitle() -> String {
        return storys[count].title
    }
    
    func getChoice1() -> String {
        return storys[count].choice1
    }
    
    func getChoice2() -> String {
        return storys[count].choice2
    }
}
